...
************************************************
ARDUINO LIBRARIES
Delete library folder in Arduino IDE and replace with the board source librairies with
specific versions.  Do not compile if not respected.

SensorLib 0.3.1
Arduino_DriveBus
ESP32_IO_Expander 0.0.3
GFX_Library_for_Arduino
lvgl 8.4.0 by kisvegabor: déja dans IDE
Mylibrary
ui_a, ui_b, ui_c
XPowersLib
lv_conf.h
